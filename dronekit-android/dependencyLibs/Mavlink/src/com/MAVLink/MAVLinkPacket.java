...
import com.MAVLink.usvmega.msg_autopilot_version_request;
import com.MAVLink.usvmega.msg_ahrs;
import com.MAVLink.usvmega.msg_ahrs2;
import com.MAVLink.usvmega.msg_ahrs3;
import com.MAVLink.usvmega.msg_airspeed_autocal;
import com.MAVLink.usvmega.msg_ap_adc;
import com.MAVLink.usvmega.msg_battery2;
import com.MAVLink.usvmega.msg_camera_feedback;
import com.MAVLink.usvmega.msg_camera_status;
import com.MAVLink.usvmega.msg_compassmot_status;
import com.MAVLink.usvmega.msg_data16;
import com.MAVLink.usvmega.msg_data32;
import com.MAVLink.usvmega.msg_data64;
import com.MAVLink.usvmega.msg_data96;
import com.MAVLink.usvmega.msg_deepstall;
import com.MAVLink.usvmega.msg_digicam_configure;
import com.MAVLink.usvmega.msg_digicam_control;
import com.MAVLink.usvmega.msg_ekf_status_report;
import com.MAVLink.usvmega.msg_fence_fetch_point;
import com.MAVLink.usvmega.msg_fence_point;
import com.MAVLink.usvmega.msg_fence_status;
import com.MAVLink.usvmega.msg_gimbal_control;
import com.MAVLink.usvmega.msg_gimbal_report;
import com.MAVLink.usvmega.msg_gimbal_torque_cmd_report;
import com.MAVLink.usvmega.msg_gopro_get_request;
import com.MAVLink.usvmega.msg_gopro_get_response;
import com.MAVLink.usvmega.msg_gopro_heartbeat;
import com.MAVLink.usvmega.msg_gopro_set_request;
import com.MAVLink.usvmega.msg_gopro_set_response;
import com.MAVLink.usvmega.msg_hwstatus;
import com.MAVLink.usvmega.msg_led_control;
import com.MAVLink.usvmega.msg_limits_status;
import com.MAVLink.usvmega.msg_mag_cal_progress;
import com.MAVLink.usvmega.msg_mag_cal_report;
import com.MAVLink.usvmega.msg_meminfo;
import com.MAVLink.usvmega.msg_mount_configure;
import com.MAVLink.usvmega.msg_mount_control;
import com.MAVLink.usvmega.msg_mount_status;
import com.MAVLink.usvmega.msg_pid_tuning;
import com.MAVLink.usvmega.msg_radio;
import com.MAVLink.usvmega.msg_rally_fetch_point;
import com.MAVLink.usvmega.msg_rally_point;
import com.MAVLink.usvmega.msg_rangefinder;
import com.MAVLink.usvmega.msg_remote_log_block_status;
import com.MAVLink.usvmega.msg_remote_log_data_block;
import com.MAVLink.usvmega.msg_rpm;
import com.MAVLink.usvmega.msg_sensor_offsets;
import com.MAVLink.usvmega.msg_set_mag_offsets;
import com.MAVLink.usvmega.msg_simstate;
import com.MAVLink.usvmega.msg_wind;
