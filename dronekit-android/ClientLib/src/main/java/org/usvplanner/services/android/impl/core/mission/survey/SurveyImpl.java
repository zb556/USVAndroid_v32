package org.usvplanner.services.android.impl.core.mission.survey;
...
import org.usvplanner.services.android.impl.core.mission.MissionItemType;
import org.usvplanner.services.android.impl.core.mission.commands.CameraTriggerImpl;
import org.usvplanner.services.android.impl.core.polygon.Polygon;
...
import org.usvplanner.services.android.impl.core.survey.grid.Grid;
import org.usvplanner.services.android.impl.core.survey.grid.GridBuilder;
...
public class SurveyImpl extends MissionItemImpl {
    ...
    private void packSurveyPoints(List<msg_mission_item> list) {
        ...
        for (LatLong point : grid.gridPoints) {
            ...
            if(camTriggerNum < grid.gridPoints.size()) {
                list.addAll(camTrigger.packMissionItem());
                camTriggerNum++;
            }
//            if(addToFirst){
