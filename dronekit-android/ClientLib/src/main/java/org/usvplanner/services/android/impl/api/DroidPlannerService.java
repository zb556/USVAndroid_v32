...
import org.usvplanner.services.android.impl.utils.Utils;
import org.usvplanner.services.android.impl.utils.file.IO.CameraInfoLoader;
...
public class DroidPlannerService extends Service {
    ...
    private Notification getNotification() {
        ...
        String CHANNEL_ONE_ID = "com.zqtdiyer.cn";
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notifBuilder.setChannelId(CHANNEL_ONE_ID);
        }
