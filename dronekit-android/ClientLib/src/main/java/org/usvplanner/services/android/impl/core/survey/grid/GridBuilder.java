...
import org.usvplanner.services.android.impl.core.helpers.geoTools.LineLatLong;
...
public class GridBuilder {
	...
	public GridBuilder(Polygon polygon, double angle, double distance, LatLong originPoint, boolean cross) {
		this.poly = polygon;
		this.origin = originPoint;
		this.angle = angle;
