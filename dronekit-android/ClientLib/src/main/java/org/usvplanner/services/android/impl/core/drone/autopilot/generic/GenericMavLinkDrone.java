package org.usvplanner.services.android.impl.core.drone.autopilot.generic;
...
import org.usvplanner.services.android.impl.core.MAVLink.MavLinkWaypoint;
import org.usvplanner.services.android.impl.core.MAVLink.WaypointManager;
import org.usvplanner.services.android.impl.core.drone.DroneEvents;
...
import org.usvplanner.services.android.impl.core.drone.autopilot.apm.APMConstants;
...
import org.usvplanner.services.android.impl.core.drone.variables.Type;
...
import org.usvplanner.services.android.impl.utils.video.VideoManager;
...
public class GenericMavLinkDrone implements MavLinkDrone {
    ...
    protected final RcIn rcIn = new RcIn();
    protected final MissionUploadPro missionUploadPro = new MissionUploadPro();
    ...
    public boolean executeAsyncAction(Action action, ICommandListener listener) {
        ...
        switch (type) {
            ...
            // CONTROL ACTIONS
            case ControlActions.ACTION_DO_GUIDED_VTOLTAKEOFF:
                return performVtolTakeoff(data, listener);
            ...
            case ControlActions.ACTION_SET_CONDITION_YAW:
                ...
                return true;
            case ControlActions.ACTION_SET_TRIGGER_DISTANCE:
                return setCameraTrigger(data, listener);
    ...
    protected boolean performVtolTakeoff(Bundle data, ICommandListener listener) {
        double takeoffAltitude = data.getDouble(ControlActions.EXTRA_ALTITUDE_VTOL);
        MavLinkCommands.sendVtolTakeoff(this, takeoffAltitude, listener);
        return true;
    }

    protected boolean setCameraTrigger(Bundle data, ICommandListener listener) {
        double distance = data.getDouble(ControlActions.EXTRA_GRIGGER_DISTANCE);
        MavLinkCommands.doCameraTrigger(this, distance, listener);
        return true;
    }
    ...
    public DroneAttribute getAttribute(String attributeType) {
        ...
        switch (attributeType) {
            ...
            case AttributeType.MISSION_WP_UP:
    ...
    protected void processRC_Channels(int chroll, int chpitch, int chthro, int chyaw, int ch5, int ch6, int ch7, int ch8, int ch9, int ch10, int ch11, int ch12) {
        rcIn.setChRoll(chroll);
        rcIn.setChPitch(chpitch);
        rcIn.setChthro(chthro);
        rcIn.setChyaw(chyaw);
        rcIn.setCh5(ch5);
        rcIn.setCh6(ch6);
        rcIn.setCh7(ch7);
