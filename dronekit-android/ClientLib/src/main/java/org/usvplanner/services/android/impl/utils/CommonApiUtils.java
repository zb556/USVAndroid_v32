...
import org.usvplanner.services.android.impl.core.MAVLink.MavLinkCommands;
import org.usvplanner.services.android.impl.core.MAVLink.command.doCmd.MavLinkDoCmds;
import org.usvplanner.services.android.impl.core.drone.autopilot.Drone;
import org.usvplanner.services.android.impl.core.drone.autopilot.MavLinkDrone;
import org.usvplanner.services.android.impl.core.drone.autopilot.apm.ArduPilot;
...
import org.usvplanner.services.android.impl.core.gcs.follow.Follow;
import org.usvplanner.services.android.impl.core.gcs.follow.FollowAlgorithm;
...
import org.usvplanner.services.android.impl.core.survey.Footprint;
...
//                return VehicleMode.ROVER_STEERING;
    ...
    public static FootPrint getProxyCameraFootPrint(Footprint footprint) {
        ...
        return new FootPrint(footprint.getGSD(), footprint.getVertexInGlobalFrame(), footprint.getCameraPoint());
    }
    ...
    public static State getState(MavLinkDrone drone, boolean isConnected, Vibration vibration) {
        ...
        org.usvplanner.services.android.impl.core.drone.variables.State droneState = drone.getState();
    ...
    public static void arm(final ArduPilot drone, final boolean arm, final boolean emergencyDisarm, final ICommandListener listener) {
        ...
        if (!arm && emergencyDisarm) {
            if (org.usvplanner.services.android.impl.core.drone.variables.Type.isCopter(drone.getType()) && !isKillSwitchSupported(drone)) {
    ...
    public static boolean isKillSwitchSupported(MavLinkDrone drone) {
        ...
        if (!org.usvplanner.services.android.impl.core.drone.variables.Type.isCopter(drone.getType()))
            return false;
    ...
    public static void startLevelCalibration(MavLinkDrone drone, ICommandListener listener) {
        if (drone != null)
            drone.getLevelCalibration().startCalibration(listener);
    }
