package org.usvplanner.services.android.impl.core.MAVLink;
...
public class MavLinkCommands {
    ...
    public static void sendVtolTakeoff(MavLinkDrone drone, double alt, ICommandListener listener) {
        msg_command_long msg = new msg_command_long();
        msg.target_system = drone.getSysid();
        msg.target_component = drone.getCompid();
        msg.command = MAV_CMD.MAV_CMD_NAV_VTOL_TAKEOFF;
    ...
    public static void doCameraTrigger(MavLinkDrone drone, double distance, ICommandListener listener) {
        msg_command_long msg = new msg_command_long();
        msg.target_system = drone.getSysid();
        msg.target_component = drone.getCompid();
        msg.command = MAV_CMD.MAV_CMD_DO_SET_CAM_TRIGG_DIST;

        msg.param1 = (float) distance;
