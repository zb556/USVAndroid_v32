...
public class AttributeType {
    ...
    /**
     * Used to access the vehicle's gps state.
     * @see {@link com.o3dr.services.android.lib.drone.property.Gps2} object.
     */
    public static final String GPS2 = PACKAGE_NAME + ".GPS2";
    /**
    ...
    public static final String RCIN = PACKAGE_NAME + ".RCIN";

    public static final String MISSION_WP_UP = PACKAGE_NAME + ".MISSION_WP_UP";
