...
public enum VehicleMode implements DroneAttribute {
    ...
    ROVER_MANUAL(0, Type.TYPE_ROVER, "手动"),
//    ROVER_LEARNING(2, Type.TYPE_ROVER, "Learning"),
//    ROVER_STEERING(3, Type.TYPE_ROVER, "Steering"),
    ROVER_HOLD(4, Type.TYPE_ROVER, "停止"),
    ROVER_AUTO(10, Type.TYPE_ROVER, "自动"),
    ROVER_RTL(11, Type.TYPE_ROVER, "返航"),
    ROVER_GUIDED(15, Type.TYPE_ROVER, "引导"),
    ROVER_INITIALIZING(16, Type.TYPE_ROVER, "初始化"),
