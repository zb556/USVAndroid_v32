...
public class ControlActions {
    ...
    public static final String ACTION_DO_GUIDED_VTOLTAKEOFF = Utils.PACKAGE_NAME + ".action.DO_GUIDED_VTOLTAKEOFF";
    public static final String EXTRA_ALTITUDE_VTOL = "extra_altitude_vtol";
    ...
    public static final String ACTION_SET_TRIGGER_DISTANCE = PACKAGE_NAME + ".SET_TRIGGER_DISTANCE";
    ...
    public static final String EXTRA_GRIGGER_DISTANCE = "extra_trigger_distance";
