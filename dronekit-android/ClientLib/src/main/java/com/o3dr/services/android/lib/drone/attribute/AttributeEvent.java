...
public class AttributeEvent {
    ...
    public static final String CALIBRATION_LEVEL = PACKAGE_NAME + ".CALIBRATION_LEVEL";
    public static final String CALIBRATION_LEVEL_TIMEOUT = PACKAGE_NAME + ".CALIBRATION_LEVEL_TIMEOUT";
    ...
    public static final String MISSION_WP_UPLOADED = PACKAGE_NAME + ".MISSION_WP_UPLOADED";
    ...
    public static final String RC_IN_UPDATE = PACKAGE_NAME + ".RC_IN_UPDATE";
