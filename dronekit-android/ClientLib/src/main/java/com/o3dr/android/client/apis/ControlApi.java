...
import static com.o3dr.services.android.lib.drone.action.ControlActions.ACTION_DO_GUIDED_VTOLTAKEOFF;
...
import static com.o3dr.services.android.lib.drone.action.ControlActions.ACTION_SET_TRIGGER_DISTANCE;
import static com.o3dr.services.android.lib.drone.action.ControlActions.EXTRA_ALTITUDE;
import static com.o3dr.services.android.lib.drone.action.ControlActions.EXTRA_ALTITUDE_VTOL;
...
import static com.o3dr.services.android.lib.drone.action.ControlActions.EXTRA_GRIGGER_DISTANCE;
...
public class ControlApi extends Api {
    ...
    /**
     * Perform a guided vtol take off.
     *
     * @param altitude altitude in meters
     * @param listener Register a callback to receive update of the command execution state.
     */
    public void vtolTakeoff(double altitude, AbstractCommandListener listener) {
        Bundle params = new Bundle();
        params.putDouble(EXTRA_ALTITUDE_VTOL, altitude);
        drone.performAsyncActionOnDroneThread(new Action(ACTION_DO_GUIDED_VTOLTAKEOFF, params), listener);
    }

    public void doCameraTrigger(double distance, AbstractCommandListener listener) {
        Bundle params = new Bundle();
        params.putDouble(EXTRA_GRIGGER_DISTANCE, distance);
        drone.performAsyncActionOnDroneThread(new Action(ACTION_SET_TRIGGER_DISTANCE, params), listener);
    }
