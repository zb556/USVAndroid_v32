...
import static com.o3dr.services.android.lib.gcs.action.CalibrationActions.ACTION_START_LEVEL_CALIBRATION;
...
public class CalibrationApi extends Api {
    ...
    public void startLevelCalibration(AbstractCommandListener listener) {
        drone.performAsyncActionOnDroneThread(new Action(ACTION_START_LEVEL_CALIBRATION), listener);
    }
