package org.usvplanner.android.maps;
...
import org.usvplanner.android.maps.providers.google_map.DownloadMapboxMapActivity;
import org.usvplanner.android.maps.providers.google_map.GoogleMapPrefConstants;
import org.usvplanner.android.maps.providers.google_map.GoogleMapPrefFragment;
import org.usvplanner.android.maps.providers.google_map.tiles.TileProviderManager;
import org.usvplanner.android.maps.providers.google_map.tiles.arcgis.ArcGISTileProviderManager;
import org.usvplanner.android.maps.providers.google_map.tiles.mapbox.MapboxTileProviderManager;
import org.usvplanner.android.maps.providers.google_map.tiles.mapbox.MapboxUtils;
...
public class GoogleMapFragment extends SupportMapFragment implements DPMap,
    ...
    private Boolean isLoop() {
        for (MissionItemProxy missionItemProxy : dpApp.getMissionProxy().getItems()) {
            if (missionItemProxy.getMissionItem().getType().toString().equals(getString(R.string.dojump_string))) {
