...
class DownloadMapboxMapActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val goToMyLocation = findViewById(R.id.my_location_button) as FloatingActionButton
        ...
        val goToDroneLocation = findViewById(R.id.drone_location_button) as FloatingActionButton
