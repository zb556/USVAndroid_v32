package org.usvplanner.android.maps.providers.baidu_map;
...
public class BaiduMapOfflineMapPreference extends DialogPreference implements MKOfflineMapListener {
    ...
    private void initView(View view) {
        ...
        mCidView = (TextView) view.findViewById(org.usvplanner.android.R.id.cityid);
        mCityNameView = (EditText) view.findViewById(org.usvplanner.android.R.id.city);
        mStateView = (TextView) view.findViewById(org.usvplanner.android.R.id.state);

        ListView hotCityList = (ListView) view.findViewById(org.usvplanner.android.R.id.hotcitylist);
