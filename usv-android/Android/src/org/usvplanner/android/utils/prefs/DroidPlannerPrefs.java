package org.usvplanner.android.utils.prefs;
...
import org.usvplanner.android.fragments.widget.video.WidgetVideoPreferences;
import org.usvplanner.android.maps.providers.DPMapProvider;
import org.usvplanner.android.tlog.TLogActivity;
...
public class DroidPlannerPrefs {
    ...
    public static final String PREF_VOLTAGE_MIN_VALUE = "pref_voltage_min_value";
    private static final float DEFAULT_MIN_VOLTAGE = 10.1f; //meters per second.

    public static final String PREF_MIS_TIME_NAME = "time_bar_key";
    public static final Integer PREF_MIS_TIME_VALUE_DEFAULT = 3;
    ...
    public float getMinVoltage() {
        return prefs.getFloat(PREF_VOLTAGE_MIN_VALUE, DEFAULT_MIN_VOLTAGE);
    }

    public int getMisTimeValue() {
        return prefs.getInt(PREF_MIS_TIME_NAME, PREF_MIS_TIME_VALUE_DEFAULT);
    }
...
//    private float getVoltagePreference(String prefKey, float minValue) {
//        final String minVoltageValue = prefs.getString(prefKey, null);
//        if (TextUtils.isEmpty(minVoltageValue))
//            return minValue;
//
//        try {
//            final float minVoltage = Float.parseFloat(minVoltageValue.trim());
//            return minVoltage;
//        } catch (Exception e) {
//            return minValue;
//        }
//    }
    ...
    public void setVoltageMinValue(float voltageValue) {
        prefs.edit().putFloat(PREF_VOLTAGE_MIN_VALUE, voltageValue).apply();
//        lbm.sendBroadcast(new Intent(PREF_VOLTAGE_MIN_VALUE));
    }

    public void setMisTimeValue(int timeValue) {
        prefs.edit().putInt(PREF_MIS_TIME_NAME, timeValue).apply();
    }
    /**  default follow mode
     * @return FollowType
     */
