package org.usvplanner.android.utils;
...
public class MapUtils {
    ...
    public static List<org.osmdroid.util.GeoPoint> coordToOsmdroidGeoPoint(List<? extends LatLong> coords) {
        List<org.osmdroid.util.GeoPoint> points = new ArrayList<>(coords.size());
        for(LatLong coord: coords){
            points.add(coordToOsmdroidGeoPoint(coord));
        }
        return points;
    }
    ...
    public static org.osmdroid.util.GeoPoint coordToOsmdroidGeoPoint(LatLong coord) {
        return new org.osmdroid.util.GeoPoint(coord.getLatitude(), coord.getLongitude());
    }
	public static LatLong baiduLatLngToCoord(com.baidu.mapapi.model.LatLng point) {
        return new LatLong((float)point.latitude, (float) point.longitude);
    }
    public static LatLong osmdroidGeoPointToCoord(org.osmdroid.util.GeoPoint point) {
        return new LatLong(point.getLatitude(), point.getLongitude());
    }
    public static LatLong osmdroidIGeoPointToCoord(org.osmdroid.api.IGeoPoint point) {
        return new LatLong(point.getLatitude(), point.getLongitude());
    }
}
