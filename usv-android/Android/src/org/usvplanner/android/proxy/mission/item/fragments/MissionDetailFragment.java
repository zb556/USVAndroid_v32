...
import org.usvplanner.android.fragments.helpers.ApiListenerDialogFragment;
...
public class MissionDetailFragment extends ApiListenerDialogFragment {
    ...
    public void onApiConnected() {
        ...
        commandAdapter = new AdapterMissionItems(getActivity(),
                android.R.layout.simple_list_item_1, list.toArray(new MissionItemType[list.size()]), true);
