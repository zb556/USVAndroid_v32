package org.usvplanner.android.notifications;
...
public class TTSNotificationProvider implements OnInitListener,
        ...
        private void speakPeriodic(Drone drone) {
            ...
            if (mIsPeriodicStatusStarted.compareAndSet(false, true)) {
                ...
                if (speechPrefs.get(DroidPlannerPrefs.PREF_TTS_PERIODIC_BAT_VOLT)) {
                    ...
                    final double battVoltage = droneBattery.getBatteryVoltage();
                    if(battVoltage < mAppPrefs.getMinVoltage()) {
                        mMessageBuilder.append("无人艇电量低 " + context.getString(R.string.periodic_status_bat_volt,
                                battVoltage));
                    }
                    else {
                ...
                if (speechPrefs.get(DroidPlannerPrefs.PREF_TTS_PERIODIC_ALT)) {
                    ...
                    if (droneGps.isValid() && droneHome.isValid()) {
                        ...
                        mMessageBuilder.append(context.getString(R.string.periodic_status_altitude, distanceToHome));
                    }
                }
                ...
                if (speechPrefs.get(DroidPlannerPrefs.PREF_TTS_PERIODIC_AIRSPEED)) {
                    ...
                    mMessageBuilder.append(context.getString(R.string.periodic_status_airspeed, droneSpeed.getAirSpeed()));
                }
    ...
    private void speakMode(VehicleMode mode) {
        ...
        switch (mode) {
            case ROVER_MANUAL:
                modeString += context.getString(R.string.speak_mode_manual);
                break;
            case ROVER_HOLD:
                modeString += context.getString(R.string.speak_mode_hold);
                break;
            case ROVER_AUTO:
                modeString += context.getString(R.string.speak_mode_auto);
                break;
            case ROVER_RTL:
                modeString += context.getString(R.string.speak_mode_rtl);
                break;
            case UNKNOWN:
                modeString += context.getString(R.string.speak_mode_unknown);
                break;
        ...
        modeString += modeString = context.getString(R.string.fly_mode_mode);
        speak(modeString);
    }
    ...
    private void speakGpsMode(int fix) {
        switch (fix) {
            ...
            case 5:
                ...
                break;
            case 6:
                speak(context.getString(R.string.gps_mode_rtk_gps_lock));
                break;
            default:
