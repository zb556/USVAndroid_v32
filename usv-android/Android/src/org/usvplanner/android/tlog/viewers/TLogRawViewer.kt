...
import org.usvplanner.android.tlog.adapters.TLogRawEventAdapter
...
class TLogRawViewer : TLogViewer() {
    ...
    private val noTLogView by lazy {
        getView()?.findViewById<TextView>(R.id.no_tlog_selected) as TextView
    }

    private val fastScroller by lazy {
        getView()?.findViewById<FastScroller>(R.id.raw_fastscroller) as FastScroller
    }

    private val rawData by lazy {
        getView()?.findViewById<RecyclerView>(R.id.tlog_raw_data) as RecyclerView
    }
