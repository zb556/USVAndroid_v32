...
import org.usvplanner.android.activities.EditorActivity
import org.usvplanner.android.droneshare.data.SessionContract
import org.usvplanner.android.tlog.adapters.TLogPositionEventAdapter
import org.usvplanner.android.tlog.event.TLogEventListener
import org.usvplanner.android.tlog.event.TLogEventMapFragment
import org.usvplanner.android.utils.MapUtils
import org.usvplanner.android.utils.SpaceTime
import org.usvplanner.android.view.FastScroller
...
class TLogPositionViewer : TLogViewer(), TLogEventListener {
    ...
    private val eventsView by lazy {
        getView()?.findViewById<RecyclerView>(R.id.event_list) as RecyclerView
    }

    private val fastScroller by lazy {
        getView()?.findViewById<FastScroller>(R.id.fast_scroller) as FastScroller
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        val goToMyLocation = view.findViewById<FloatingActionButton>(R.id.my_location_button) as FloatingActionButton
