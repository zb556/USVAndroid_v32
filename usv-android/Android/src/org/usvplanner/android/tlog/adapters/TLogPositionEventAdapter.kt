package org.usvplanner.android.tlog.adapters
...
import org.usvplanner.android.tlog.viewers.TLogPositionViewer
...
import org.usvplanner.android.view.adapterViews.AbstractRecyclerViewFooterAdapter
...
class TLogPositionEventAdapter(context : Context, recyclerView: RecyclerView) :
    ...
    override fun onCreateBasicItemViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val timestamp = container.findViewById<TextView>(R.id.event_timestamp) as TextView
        val altitude = container.findViewById<TextView>(R.id.event_altitude) as TextView
    ...
    override fun onCreateFooterViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val progressBar = container.findViewById<ProgressBar>(R.id.progressBar) as ProgressBar
