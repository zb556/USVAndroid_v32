...
import org.usvplanner.android.view.adapterViews.OnLoadMoreListener
...
class TLogRawEventAdapter(recyclerView: RecyclerView, onLoadMoreListener: OnLoadMoreListener?) :
    ...
    override fun onCreateBasicItemViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val eventTimestamp = eventView.findViewById<TextView>(R.id.event_timestamp) as TextView
        val eventInfo = eventView.findViewById<TextView>(R.id.event_info) as TextView
    ...
    override fun onCreateFooterViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val progressBar = v.findViewById<ProgressBar>(R.id.progressBar) as ProgressBar
