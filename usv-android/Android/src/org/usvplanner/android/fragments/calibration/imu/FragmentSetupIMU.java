package org.usvplanner.android.fragments.calibration.imu;
...
public class FragmentSetupIMU extends ApiListenerFragment {
	...
	private void processOrientation(String message) {
		...
		if (message.contains("level")) {
		    msg = (String) getText(R.string.cal_acc_level);
            calibration_step = 1;
        }
		else if (message.contains("LEFT")) {
            msg = (String) getText(R.string.cal_acc_left);
            calibration_step = 2;
        }
		else if (message.contains("RIGHT")) {
            msg = (String) getText(R.string.cal_acc_right);
            calibration_step = 3;
        }
		else if (message.contains("DOWN")){
            msg = (String) getText(R.string.cal_acc_down);
            calibration_step = 4;
        }
		else if (message.contains("UP")){
            msg = (String) getText(R.string.cal_acc_up);
            calibration_step = 5;
        }
		else if (message.contains("BACK")){
            msg = (String) getText(R.string.cal_acc_back);
            calibration_step = 6;
        }
		else if (message.contains("Calibration")){
		    if(message.contains("successful")) {
                msg = (String) getText(R.string.cal_acc_suc);
            }
            if(message.contains("FAILED")) {
                msg = (String) getText(R.string.cal_acc_fail);
            }
			calibration_step = 7;
		}
