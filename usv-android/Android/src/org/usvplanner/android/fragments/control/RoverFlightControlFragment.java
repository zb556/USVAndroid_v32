package org.usvplanner.android.fragments.control;
...
public class RoverFlightControlFragment extends BaseFlightControlFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        manualBtn = (Button) view.findViewById(R.id.mc_manual);
...
//                case ROVER_HOLD:
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.mc_manual: {
                VehicleApi.getApi(drone).setVehicleMode(VehicleMode.ROVER_MANUAL);
                eventBuilder.setAction(ACTION_FLIGHT_ACTION_BUTTON).setLabel(VehicleMode.ROVER_MANUAL.getLabel());
                break;
            }
