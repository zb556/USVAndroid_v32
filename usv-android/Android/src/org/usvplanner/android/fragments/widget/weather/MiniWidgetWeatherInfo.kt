package org.usvplanner.android.fragments.widget.weather
...
import org.usvplanner.android.utils.NetworkUtils
...
class MiniWidgetWeatherInfo : TowerWidget() {
    ...
    private val windSpeed by lazy {
        getView()?.findViewById<TextView>(R.id.weather_wind_speed) as TextView
    }

    private val precipitationChances by lazy {
        getView()?.findViewById<TextView>(R.id.weather_precipitation) as TextView
    }
    private val temperature by lazy {
        getView()?.findViewById<TextView>(R.id.weather_temperature) as TextView
    }

    private val weatherLocation by lazy {
        getView()?.findViewById<TextView>(R.id.weather_location) as TextView
    }
