...
import org.usvplanner.android.view.AttitudeIndicator
import java.util.*
...
//    private var verticalSpeed: TextView? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        attitudeIndicator = view.findViewById<AttitudeIndicator>(R.id.aiView) as AttitudeIndicator

        roll = view.findViewById<TextView>(R.id.rollValueText) as TextView
        yaw = view.findViewById<TextView>(R.id.yawValueText) as TextView
        pitch = view.findViewById<TextView>(R.id.pitchValueText) as TextView

        horizontalSpeed = view.findViewById<TextView>(R.id.horizontal_speed_telem) as TextView
//        verticalSpeed = view.findViewById<TextView>(R.id.vertical_speed_telem) as TextView
    }
    ...
    private fun onOrientationUpdate() {
        ...
        roll?.text = "横摇:" + String.format(Locale.US, "%3.0f\u00B0", r)
        pitch?.text = "纵摇:" + String.format(Locale.US, "%3.0f\u00B0", p)
        yaw?.text = "航向:" + String.format(Locale.US, "%3.0f\u00B0", y)
