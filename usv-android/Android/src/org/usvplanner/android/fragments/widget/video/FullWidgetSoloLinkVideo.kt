...
import org.usvplanner.android.dialogs.LoadingDialog
...
public class FullWidgetSoloLinkVideo : BaseVideoWidget() {
    ...
    private val textureView by lazy(LazyThreadSafetyMode.NONE) {
        view?.findViewById<TextureView>(R.id.sololink_video_view) as TextureView
    }

    private val videoStatus by lazy(LazyThreadSafetyMode.NONE) {
        view?.findViewById<TextView>(R.id.sololink_video_status) as TextView
    }
