package org.usvplanner.android.fragments.actionbar;
...
import org.usvplanner.android.dialogs.SelectionListModeDialog;
import org.usvplanner.android.dialogs.SelectionListRTLDialog;
...
public class ActionBarTelemFragment extends ApiListenerFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        homeTelem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    final SelectionListRTLDialog selectionDialog = SelectionListRTLDialog.newInstance(getDrone(), appPrefs);
        ...
        flightModeTelem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    final SelectionListModeDialog selectionDialog = SelectionListModeDialog.newInstance(drone);
    ...
    private void updateBatteryTelem() {
        ...
        if (!drone.isConnected() || ((droneBattery = drone.getAttribute(AttributeType.BATTERY)) == null)) {
            ...
            update = String.format(Locale.ENGLISH, "%2.1fV", battVoltage);
            if(battVoltage < appPrefs.getMinVoltage()) {
                batteryTelem.setTextColor(Color.RED);
            }
            else {
                batteryTelem.setTextColor(Color.rgb(0,150,136));
            }
