...
public class FlightModeAdapter(context: Context, val drone: Drone) : SelectionListAdapter<VehicleMode>(context) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View{
        ...
        val holder = (containerView.tag as ViewHolder?) ?: ViewHolder(containerView.findViewById<TextView>(R.id.item_selectable_option) as TextView,
                containerView.findViewById<RadioButton>(R.id.item_selectable_check) as RadioButton)
