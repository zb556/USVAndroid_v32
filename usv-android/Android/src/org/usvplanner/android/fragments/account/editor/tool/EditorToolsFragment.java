package org.usvplanner.android.fragments.account.editor.tool;
...
import org.usvplanner.android.proxy.mission.item.adapters.AdapterMissionItems;
import org.usvplanner.android.view.button.RadioButtonCenter;
...
public class EditorToolsFragment extends ApiListenerFragment implements OnClickListener, SupportYesNoDialog.Listener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final AdapterMissionItems drawItemsAdapter = new AdapterMissionItems(context,
                R.layout.spinner_drop_down_mission_item, DrawToolsImpl.DRAW_ITEMS_TYPE, false);
        ...
        final AdapterMissionItems markerItemsAdapter = new AdapterMissionItems(context,
                R.layout.spinner_drop_down_mission_item, MarkerToolsImpl.MARKER_ITEMS_TYPE, true);
